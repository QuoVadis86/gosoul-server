...
func TestCheckWinTanyao(t *testing.T) {
	...
	win := CheckWin(0, hand, nil, true, -1, nil, false)
	if win == nil {
...
func TestCheckWinNotAWin(t *testing.T) {
	...
	if w := CheckWin(0, hand, nil, true, -1, nil, false); w != nil {
...
func TestCheckWinRon(t *testing.T) {
	...
	win := CheckWin(2, hand, nil, false, 3, nil, false)
	if win == nil {
...
func TestCheckWinWithOpenMeld(t *testing.T) {
	...
	win := CheckWin(1, hand, open, true, -1, nil, false)
	if win == nil {
...
func TestCheckWinDoraAddsHan(t *testing.T) {
	...
	win := CheckWin(0, hand, nil, true, -1, []Tile{"4m", "9z", "9z", "9z", "9z"}, false)
	if win == nil {
